...
(function() {
    // Extract boardId from API_URL pattern: https://webapi-{boardId}.railway.app
    function getBoardId() {
        // Try to extract from CONFIG.API_URL pattern: https://webapi-{boardId}.railway.app
        // CONFIG is defined later in this file, so we check at runtime
    ...
    function getApiBaseUrl() {
        // Get API base URL from CONFIG if available, otherwise use current origin
    ...
    window.addEventListener('load', function() {
        ...
        const frontendLogEndpoint = apiBaseUrl + '/api/Mentor/runtime-error-frontend';
...
const CONFIG = {
    API_URL: "https://webapi696a78bd219ea83b96751fe5-production.up.railway.app"
};
